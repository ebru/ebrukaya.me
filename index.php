    ...
    <div class="container">
        <div class="row">
            ...
            <div class="seven columns">
                <h3><b>Hi! I'm Ebru.</b></h3>
                <h5>Software Engineer at Sony, backpacker and lover of nature 🍃</h5>
                <p>I graduated from Istanbul University with a degree in Computer Engineering and was an exchange student specialized in Human-Computer Interaction at Tallinn University in Estonia.</p>
                ...
                <p>
                    <a href="https://www.linkedin.com/in/ebrukaya/" target="_blank"><img src="images/social/linkedin.png" style="width: 30px; padding-right: 9px" /></a>
                    <a href="https://www.instagram.com/hayallerimdeben/" target="_blank"><img src="images/social/instagram.png" style="width: 28px; padding-right: 10px" /></a>
                    <a href="https://www.github.com/ebrukye" target="_blank"><img src="images/social/github.png" style="width: 28px" /></a>
                </p>
            </div>
                ...
                <nav class="navbar">
                    <div class="container">
                        <ul class="navbar-list">
                            ...
                            <li class="navbar-item"><a class="navbar-link" href="#education">Education</a></li>
                            ...
                            <li class="navbar-item"><a class="navbar-link" href="#personal">Personal</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
        ...
        <div class="row">
            ...
            <div class="docs-section" id="experience">
                <h3 class="docs-header">Experience</h3>
