	...
	return (
		<MainContainer>
			<div>
				...
				<Snippet>Full Stack Maker at <CustomLink targetUrl='https://noecrafts.com'>Noe Crafts</CustomLink>, backpacker and lover of nature <CustomEmoji label='leaf' emoji='🍃' /></Snippet>
				<Description>
